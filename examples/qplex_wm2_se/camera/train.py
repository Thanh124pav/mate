...
# Run: python -m examples.qplex_wm2_se.camera.train --env MATE-4v8-9.yaml
...
import mate
from examples.qplex_wm2_se.camera.config import config
...
def train(experiment, project=None, group=None, local_dir=None,
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'qplex_wm2_se.camera.{experiment.name}'
