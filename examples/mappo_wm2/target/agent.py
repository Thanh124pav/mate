...
import mate
from examples.mappo_wm2.target.config import config as _config
from examples.mappo_wm2.target.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class MAPPOWM2TargetAgent(RLlibPolicyMixIn, mate.TargetAgentBase):
    """MAPPO Target Agent
