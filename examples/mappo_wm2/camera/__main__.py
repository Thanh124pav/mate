...
.. code:: bash
    ...
    python3 -m examples.mappo_wm2.camera

    python3 -m mate.evaluate --episodes 1 --render-communication \
        --camera-agent examples.mappo_wm2:MAPPOWM2CameraAgent \
...
import mate
from examples.mappo_wm2.camera.agent import MAPPOWM2CameraAgent
from examples.mappo_wm2.camera.train import experiment
...
def main():
    ...
    if not os.path.exists(args.checkpoint_path):
        print(
            (
                ...
                f'  python -m examples.mappo_wm2.camera.train'
            ),
            file=sys.stderr,
        )
        sys.exit(1)
    ...
    # Make agents ##############################################################
    camera_agent = MAPPOWM2CameraAgent(checkpoint_path=args.checkpoint_path)
