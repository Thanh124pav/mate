...
import mate
from examples.mappo_wm2.camera.config import config as _config
from examples.mappo_wm2.camera.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class MAPPOWM2CameraAgent(RLlibPolicyMixIn, mate.CameraAgentBase):
    """MAPPO Camera Agent
