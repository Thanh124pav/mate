...
import mate
from examples.tarmac_wm2.camera.config import config as _config
from examples.tarmac_wm2.camera.config import make_env as _make_env
from examples.tarmac_wm2.models import TarMACWM2Model
from examples.utils import RLlibPolicyMixIn


class TarMACWM2CameraAgent(RLlibPolicyMixIn, mate.CameraAgentBase):
    """TarMAC Camera Agent
    ...
    def __init__(self, config=None, checkpoint_path=None, make_env=_make_env, seed=None):
        ...
        assert isinstance(self.model, TarMACWM2Model)
