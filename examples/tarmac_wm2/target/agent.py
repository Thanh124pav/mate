...
from examples.tarmac_wm2.target.config import config as _config
from examples.tarmac_wm2.target.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class TarMACWM2TargetAgent(RLlibPolicyMixIn, mate.TargetAgentBase):
    """TarMAC Target Agent
