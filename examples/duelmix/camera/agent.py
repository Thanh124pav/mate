...
import mate
from ray.rllib.agents.duelmix.duelmix_policy import DuelMixTorchPolicy

from examples.duelmix.camera.config import config as _config
from examples.duelmix.camera.config import make_env as _make_env
from examples.utils import RLlibGroupedPolicyMixIn


class DuelMixCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """DuelMIX Camera Agent (pure, DiscreteCamera)."""

    POLICY_CLASS = DuelMixTorchPolicy
