...
# Run: python -m examples.duelmix.camera.train
...
from examples.duelmix.camera.config import config
...
def train(experiment, project=None, group=None, local_dir=None,
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'duelmix.camera.{experiment.name}'
...
def main():
    ...
    parser.add_argument('--buffer-capacity', type=float, metavar='EPISODE', default=200)
