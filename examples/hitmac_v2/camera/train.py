...
from examples.hitmac_v2.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hitmac-v2.ppo.camera.{experiment.name}'
...
def main():
    ...
    parser.add_argument('--env', default=None, help='MATE .yaml config file')
