#!/usr/bin/env python3
"""HiTMAC Phase 2A — Train QPLEX_V2 coordinator với fixed Phase 1 QPLEX executor.
...
from examples.hitmac.coordinator.qplex_v2.camera.config import config
...
NUM_GPUS_FOR_TRAINER = min(NUM_NODE_GPUS, 0.75)
...
experiment = tune.Experiment(
    name='HiTMAC-Coordinator-QPLEX_V2',
    run='QPLEX_V2',
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hitmac.coordinator.qplex_v2.camera.{experiment.name}'
