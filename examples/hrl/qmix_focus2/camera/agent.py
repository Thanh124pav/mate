...
import mate
from examples.hrl.qmix_focus2.camera.config import config as _config
from examples.hrl.qmix_focus2.camera.config import make_env as _make_env
...
class HRLQMIXFocusCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QMIX+FOCUS2 Camera Agent
    ...
    POLICY_CLASS = QMixFocus2TorchPolicy
