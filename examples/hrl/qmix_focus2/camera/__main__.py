...
r"""
Example of hierarchical QMIX+FOCUS2 agents for the Multi-Agent Tracking Environment.

.. code:: bash

    python3 -m examples.hrl.qmix_focus2.camera

    python3 -m mate.evaluate --episodes 1 --render-communication \
        --camera-agent examples.hrl.qmix_focus2.camera:CameraAgent \
        --camera-kwargs '{ "checkpoint_path": "examples/hrl/qmix_focus2/camera/ray_results/HRL-QMIX-FOCUS2/latest-checkpoint" }'
"""
...
import mate
from examples.hrl.qmix_focus2.camera.agent import HRLQMIXFocusCameraAgent
from examples.hrl.qmix_focus2.camera.train import experiment
...
def main():
    ...
    if not os.path.exists(args.checkpoint_path):
        print(
            (
                ...
                f'  python -m examples.hrl.qmix_focus2.camera.train'
            ),
            file=sys.stderr,
        )
        sys.exit(1)
    ...
    # Make agents ##############################################################
    camera_agent = HRLQMIXFocusCameraAgent(checkpoint_path=args.checkpoint_path)
