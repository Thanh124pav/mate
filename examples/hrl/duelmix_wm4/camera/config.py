...
from ray.rllib.agents.duelmix_wm4 import DEFAULT_CONFIG
...
from ray.rllib.agents.duelmix_wm4.evasive_target import EvasiveTargetAgent
...
tune.register_env('mate-hrl.duelmix_wm4.camera', make_env)

from ray.rllib.agents.duelmix_wm4.duelmix import DuelMixWM4Trainer

tune.register_trainable('DUELMIX_WM4', DuelMixWM4Trainer)

config = {
    **DEFAULT_CONFIG,
    'framework': 'torch',
    'seed': 0,
    'env': 'mate-hrl.duelmix_wm4.camera',
    'env_config': {
