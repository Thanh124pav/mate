...
from ray.rllib.agents.duelmix_wm4.duelmix_policy import DuelMixWM4TorchPolicy

import mate
from examples.hrl.duelmix_wm4.camera.config import config as _config
from examples.hrl.duelmix_wm4.camera.config import make_env as _make_env
...
class HRLDuelMixWM4_CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """HRL DuelMix_WM4 Camera Agent."""

    POLICY_CLASS = DuelMixWM4TorchPolicy
