...
# Run: python -m examples.hrl.spectra.camera.train
...
from examples.hrl.spectra.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl.spectra.camera.{experiment.name}'
