...
from ray.rllib.agents.spectra.spectra_policy import SPECTraTorchPolicy

import mate
from examples.hrl.spectra.camera.config import config as _config
from examples.hrl.spectra.camera.config import make_env as _make_env
...
class HRLSPECTraCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical SPECTra Camera Agent."""

    POLICY_CLASS = SPECTraTorchPolicy
