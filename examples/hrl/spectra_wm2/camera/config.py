"""HRL-SPECTra config — same HierarchicalCamera wrapper as HRL-QPLEX but with SPECTra."""

import copy

from gym import spaces
from ray import tune
from ray.rllib.agents.spectra_wm2 import spectra
from ray.rllib.agents.spectra_wm2.spectra import SPECTraWM2Trainer
...
tune.register_env('mate-hrl.spectra_wm2.camera', make_env)
tune.register_trainable('SPECTRA_WM2', SPECTraWM2Trainer)

config = {
    **spectra.DEFAULT_CONFIG,
    'framework': 'torch',
    'seed': 0,
    'env': 'mate-hrl.spectra_wm2.camera',
    'env_config': {
