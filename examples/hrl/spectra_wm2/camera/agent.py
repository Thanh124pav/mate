...
from ray.rllib.agents.spectra_wm2.spectra_policy import SPECTraWM2TorchPolicy

import mate
from examples.hrl.spectra_wm2.camera.config import config as _config
from examples.hrl.spectra_wm2.camera.config import make_env as _make_env
...
class HRLSPECTraWM2CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical SPECTra Camera Agent."""

    POLICY_CLASS = SPECTraWM2TorchPolicy
