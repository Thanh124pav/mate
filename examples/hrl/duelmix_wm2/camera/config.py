...
from ray.rllib.agents.duelmix_wm2 import DEFAULT_CONFIG
...
from ray.rllib.agents.duelmix_wm2.evasive_target import EvasiveTargetAgent
...
tune.register_env('mate-hrl.duelmix_wm2.camera', make_env)

from ray.rllib.agents.duelmix_wm2.duelmix import DuelMixWM2Trainer

tune.register_trainable('DUELMIX_WM2', DuelMixWM2Trainer)

config = {
    **DEFAULT_CONFIG,
    'framework': 'torch',
    'seed': 0,
    'env': 'mate-hrl.duelmix_wm2.camera',
    'env_config': {
