...
import mate
from examples.hrl.duelmix_wm2.camera.config import config as _config
from examples.hrl.duelmix_wm2.camera.config import make_env as _make_env
...
class HRLDuelMixWM2_CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """HRL DuelMix_WM2 Camera Agent."""

    POLICY_CLASS = DuelMixWM2TorchPolicy
