...
from ray.rllib.agents.qplex_v2.qplex import QPLEXTorchPolicy as QPLEXV2TorchPolicy

import mate 
from examples.hrl.qplex_v2.camera.config import config as _config
from examples.hrl.qplex_v2.camera.config import make_env as _make_env
...
class HRLQPLEXV2CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QPLEXV2 Camera Agent
    ...
    POLICY_CLASS = QPLEXV2TorchPolicy
