#!/usr/bin/env python3
# Run: python -m examples.hrl.qplex_distill.camera.train
...
from examples.hrl.qplex_distill.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl.qplex_distill.camera.{experiment.name}'
