...
from ray.rllib.agents.qplex_distill import DEFAULT_CONFIG
...
tune.register_env('mate-hrl.qplex_distill.camera', make_env)

from ray.rllib.agents.qplex_distill.qplex import QPlexDistillTrainer
tune.register_trainable('QPLEX_DISTILL', QPlexDistillTrainer)
...
config = {
    **DEFAULT_CONFIG,
    ...
    'seed': 0,
    # === Environment =========================================================
    'env': 'mate-hrl.qplex_distill.camera',
    'env_config': {
