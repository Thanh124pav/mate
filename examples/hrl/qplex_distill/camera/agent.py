...
from ray.rllib.agents.qplex_distill.qplex_policy import QPLEXDistillTorchPolicy

import mate
from examples.hrl.qplex_distill.camera.config import config as _config
from examples.hrl.qplex_distill.camera.config import make_env as _make_env
...
class HRLQPLEXDistillCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QPLEX-Distill Camera Agent (greedy BC distillation)."""

    POLICY_CLASS = QPLEXDistillTorchPolicy
