...
from examples.mappo_wm2.models import MAPPOWM2Model
...
tune.register_env('mate-hrl.mappo_wm2.camera', make_env)

config = {
    'framework': 'torch',
    'seed': 0,
    # === Environment ==============================================================================
    'env': 'mate-hrl.mappo_wm2.camera',
    'env_config': {
