...
import mate
from examples.hrl.mappo_wm2.camera.config import config as _config
from examples.hrl.mappo_wm2.camera.config import make_env as _make_env
from examples.hrl.wrappers import HierarchicalCamera
from examples.utils import RLlibPolicyMixIn


class HRLMAPPOWM2CameraAgent(RLlibPolicyMixIn, mate.CameraAgentBase):
