...
# Run: python -m examples.hrl.duelmix_focus2.camera.train
...
from examples.hrl.duelmix_focus2.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl.duelmix_focus2.camera.{experiment.name}'
    ...
    with open('examples/hrl/duelmix_focus2/config.txt', 'w', encoding='utf-8') as f:
