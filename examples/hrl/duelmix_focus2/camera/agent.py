...
from examples.hrl.duelmix_focus2.camera.config import config as _config
from examples.hrl.duelmix_focus2.camera.config import make_env as _make_env
...
class HRLDuelMixFocusCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """HRL DuelMIX+FOCUS2 Camera Agent."""

    POLICY_CLASS = DuelMixFocus2TorchPolicy
