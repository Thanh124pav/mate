"""HRL-DuelMIX config — same HierarchicalCamera wrapper as HRL-QPLEX but with DuelMIX."""

import copy

from gym import spaces
from ray import tune
from ray.rllib.agents.duelmix_focus2 import duelmix
...
tune.register_env('mate-hrl.duelmix_focus2.camera', make_env)

config = {
    **duelmix.DEFAULT_CONFIG,
    'framework': 'torch',
    'seed': 0,
    'env': 'mate-hrl.duelmix_focus2.camera',
    'env_config': {
