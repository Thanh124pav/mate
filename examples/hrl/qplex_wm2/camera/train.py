...
# Run: python -m examples.hrl.qplex_wm2.camera.train
...
import mate
from examples.hrl.qplex_wm2.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl.qplex_wm2.camera.{experiment.name}'
