...
import mate
from examples.hrl.qplex_wm2.camera.config import config as _config
from examples.hrl.qplex_wm2.camera.config import make_env as _make_env
...
class HRLQPLEXWM2_CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QPLEX + World Model V2 Camera Agent.

    A wrapper for the trained RLlib policy with world model v2 augmentation.
    The world model predicts future target positions during training,
