...
tune.register_env('mate-hrl.qplex_wm.camera', make_env)
...
config = {
    **DEFAULT_CONFIG,
    ...
    'world_model': {
        ...
        'd_ff': 64,             # expert FFN hidden dim
        'alpha': 2,             # experts per camera
        'top_k': 2,             # experts activated per token
        'dropout': 0.0,
        'loss_weight': 0.1,     # auxiliary loss weight
