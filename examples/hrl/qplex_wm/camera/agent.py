...
import mate
from examples.hrl.qplex_wm.camera.config import config as _config
from examples.hrl.qplex_wm.camera.config import make_env as _make_env
...
class HRLQPLEXWM_CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QPLEX + World Model Camera Agent.

    A wrapper for the trained RLlib policy with world model augmentation.
