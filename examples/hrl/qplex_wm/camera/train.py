...
# Run: python -m examples.hrl.qplex_wm.camera.train
...
import mate
from examples.hrl.qplex_wm.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl.qplex_wm.camera.{experiment.name}'
