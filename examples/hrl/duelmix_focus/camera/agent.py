...
from examples.hrl.duelmix_focus.camera.config import config as _config
from examples.hrl.duelmix_focus.camera.config import make_env as _make_env
...
class HRLDuelMixFocusCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """HRL DuelMIX+FOCUS Camera Agent."""
