...
from examples.ippo_wm2.models import IPPOLocalWM2Model
...
tune.register_env('mate-hrl.ippo_wm2.camera', make_env)
config = {
    'framework': 'torch',
    'seed': 0,
    # === Environment ==============================================================================
    'env': 'mate-hrl.ippo_wm2.camera',
    'env_config': {
    ...
    'model': {
        'max_seq_len': 25,
        'custom_model': IPPOLocalWM2Model,
        'custom_model_config': {
            **MODEL_DEFAULTS,
