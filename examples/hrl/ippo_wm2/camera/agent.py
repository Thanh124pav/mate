...
import mate
from examples.hrl.ippo_wm2.camera.config import config as _config
from examples.hrl.ippo_wm2.camera.config import make_env as _make_env
from examples.hrl.wrappers import HierarchicalCamera
from examples.utils import RLlibPolicyMixIn


class HRLIPPOWM2CameraAgent(RLlibPolicyMixIn, mate.CameraAgentBase):
