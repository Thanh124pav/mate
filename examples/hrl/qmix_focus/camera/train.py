...
# Run: python3 -m examples.hrl.qmix_focus.camera.train
...
from examples.hrl.qmix_focus.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl.qmix_focus.camera.{experiment.name}'
