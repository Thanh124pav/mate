...
# Run: python3 -m examples.hrl.qmix_wm2.camera.train
...
from examples.hrl.qmix_wm2.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl.qmix_wm2.camera.{experiment.name}'
