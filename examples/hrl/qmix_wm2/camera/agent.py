...
import mate
from examples.hrl.qmix_wm2.camera.config import config as _config
from examples.hrl.qmix_wm2.camera.config import make_env as _make_env
...
class HRLQMIXWM2CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    ...
    POLICY_CLASS = QMixWM2TorchPolicy
