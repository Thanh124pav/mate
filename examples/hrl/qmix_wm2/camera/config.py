...
from ray.rllib.agents.qmix_wm2 import qmix
from ray.rllib.agents.qmix_wm2.qmix import QMixWM2Trainer
...
tune.register_env('mate-hrl.qmix_wm2.camera', make_env)
tune.register_trainable('QMIX_WM2', QMixWM2Trainer)
