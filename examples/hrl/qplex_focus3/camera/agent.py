...
import mate 
from examples.hrl.qplex_focus3.camera.config import config as _config
from examples.hrl.qplex_focus3.camera.config import make_env as _make_env
...
class HRLQPLEXFocus3CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QPLEX+FOCUS3 Camera Agent
    ...
    POLICY_CLASS = QPLEXFocus3TorchPolicy
