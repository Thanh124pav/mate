...
import mate
from examples.hrl.dqn_focus.camera.config import config as _config
from examples.hrl.dqn_focus.camera.config import make_env as _make_env
...
class HRLDQNFocusCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical independent DQN+FOCUS Camera Agent
