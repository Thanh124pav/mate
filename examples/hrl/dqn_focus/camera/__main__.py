...
r"""
Example of hierarchical independent DQN+FOCUS agents for the Multi-Agent Tracking Environment.

.. code:: bash

    python3 -m examples.hrl.dqn_focus.camera
...
import mate
from examples.hrl.dqn_focus.camera.agent import HRLDQNFocusCameraAgent
from examples.hrl.dqn_focus.camera.train import experiment
...
def main():
    ...
    if not os.path.exists(args.checkpoint_path):
        print(
            (
                ...
                f'  python -m examples.hrl.dqn_focus.camera.train'
            ),
            file=sys.stderr,
        )
        sys.exit(1)
    ...
    # Make agents ##############################################################
    camera_agent = HRLDQNFocusCameraAgent(checkpoint_path=args.checkpoint_path)
