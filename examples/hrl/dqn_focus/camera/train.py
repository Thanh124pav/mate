...
# Run: python3 -m examples.hrl.dqn_focus.camera.train
...
from examples.hrl.dqn_focus.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl.dqn_focus.camera.{experiment.name}'
