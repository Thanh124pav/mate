...
from examples.hrl.duelmix.camera.config import config as _config
from examples.hrl.duelmix.camera.config import make_env as _make_env
...
class HRLDuelMixCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """HRL DuelMIX Camera Agent."""
