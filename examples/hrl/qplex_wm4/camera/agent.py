...
import mate
from examples.hrl.qplex_wm4.camera.config import config as _config
from examples.hrl.qplex_wm4.camera.config import make_env as _make_env
...
class HRLQPLEXWM4_CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """HRL QPLEX_WM4 Camera Agent."""
