...
from ray.rllib.agents.qplex_focus2 import DEFAULT_CONFIG
...
tune.register_env('mate-hrl.qplex_focus2.camera', make_env)
...
config = {
    **DEFAULT_CONFIG,
    ...
    'seed': 0,
    # === Environment ==============================================================================
    'env': 'mate-hrl.qplex_focus2.camera',
    'env_config': {
