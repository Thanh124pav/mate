...
import mate 
from examples.hrl.qplex_focus2.camera.config import config as _config
from examples.hrl.qplex_focus2.camera.config import make_env as _make_env
...
class HRLQPLEXFocus2CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QPLEX+FOCUS2 Camera Agent
    ...
    POLICY_CLASS = QPLEXFocus2TorchPolicy
