...
from ray.rllib.agents.qplex_focus_v2 import DEFAULT_CONFIG
...
tune.register_env('mate-hrl.qplex_focus_v2.camera', make_env)
...
config = {
    **DEFAULT_CONFIG,
    ...
    'seed': 0,
    # === Environment ==============================================================================
    'env': 'mate-hrl.qplex_focus_v2.camera',
    'env_config': {
