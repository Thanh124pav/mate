...
import mate 
from examples.hrl.qplex_focus_v2.camera.config import config as _config
from examples.hrl.qplex_focus_v2.camera.config import make_env as _make_env
...
class HRLQPLEXFocusV2CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QPLEX+FOCUS-V2 Camera Agent
    ...
    POLICY_CLASS = QPLEXFocusV2TorchPolicy
