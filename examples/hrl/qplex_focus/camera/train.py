...
from examples.hrl.qplex_focus.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl.qplex_focus.camera.{experiment.name}'
    ...
    with open('examples/hrl/qplex_focus/config.txt', 'w', encoding='utf-8') as f:
