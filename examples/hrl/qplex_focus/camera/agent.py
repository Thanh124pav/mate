...
import mate 
from examples.hrl.qplex_focus.camera.config import config as _config
from examples.hrl.qplex_focus.camera.config import make_env as _make_env
...
class HRLQPLEXFocusCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QPLEX+FOCUS Camera Agent
