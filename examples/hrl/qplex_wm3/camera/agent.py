...
import mate
from examples.hrl.qplex_wm3.camera.config import config as _config
from examples.hrl.qplex_wm3.camera.config import make_env as _make_env
...
class HRLQPLEXWM3_CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """HRL QPLEX_WM3 Camera Agent — Distributional Q + Stochastic World Model."""
