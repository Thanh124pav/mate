...
from ray.rllib.agents.qplex.qplex import QPLEXTorchPolicy

import mate 
from examples.hrl.qplex.camera.config import config as _config
from examples.hrl.qplex.camera.config import make_env as _make_env
...
class HRLQPLEXCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """Hierarchical QPLEX Camera Agent
