...
# Run: python -m examples.hrl.qplex.camera.train
...
from examples.hrl.qplex.camera.config import config
...
def train(
    ...
    with open('examples/hrl/qplex_v2/config.txt', 'w', encoding='utf-8') as f:
