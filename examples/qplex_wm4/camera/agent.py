...
from examples.qplex_wm4.camera.config import config as _config
from examples.qplex_wm4.camera.config import make_env as _make_env
from examples.utils import RLlibGroupedPolicyMixIn


class QPlexWM4CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """QPLEX_WM4 Camera Agent (pure, DiscreteCamera)."""

    POLICY_CLASS = QPLEXWM4TorchPolicy
