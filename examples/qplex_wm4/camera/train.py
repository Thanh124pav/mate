...
# Run: python -m examples.qplex_wm4.camera.train --env MATE-4v8-9.yaml
...
from examples.qplex_wm4.camera.config import config
...
def train(experiment, project=None, group=None, local_dir=None,
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'qplex_wm4.camera.{experiment.name}'
