...
# Run: python -m examples.qplex_v2.camera.train --project mate-4v5-0
...
from examples.qplex_v2.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'qplex_v2.camera.{experiment.name}'
