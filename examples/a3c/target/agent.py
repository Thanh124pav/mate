...
import mate
from examples.a3c.target.config import config as _config
from examples.a3c.target.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class A3CTargetAgent(RLlibPolicyMixIn, mate.TargetAgentBase):
    """A3C Target Agent
