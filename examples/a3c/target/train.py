...
# Run: python3 -m examples.a3c.target.train
...
from examples.a3c.target.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'a3c.target.{experiment.name}'
    ...
    # Update train batch size for A3C
    if num_workers > 0:
