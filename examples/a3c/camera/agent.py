...
import mate
from examples.a3c.camera.config import config as _config
from examples.a3c.camera.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class A3CCameraAgent(RLlibPolicyMixIn, mate.CameraAgentBase):
    """A3C Camera Agent

    A wrapper for the trained RLlib policy using the A3C algorithm.
