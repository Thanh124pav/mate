...
# Run: python -m examples.hrl_v2.mappo.camera.train
...
from examples.hrl_v2.mappo.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl_v2.mappo.camera.{experiment.name}'
    ...
    if total_envs > 0:
        experiment.spec['config']['train_batch_size'] = max(2000, total_envs * 200)
