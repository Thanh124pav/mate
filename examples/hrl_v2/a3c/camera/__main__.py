...
r"""
HRL V2 A3C Camera Agent - Low-level Control Learning.
...
.. code:: bash
    ...
    # Train
    python3 -m examples.hrl_v2.a3c.camera.train
    
    # Evaluate
    python3 -m examples.hrl_v2.a3c.camera \
        --checkpoint-path examples/hrl_v2/a3c/camera/ray_results/HRLv2-A3C-LowLevel/latest-checkpoint

Architecture:
- High-level: Greedy target assignment (hard-coded)
- Low-level: A3C learned camera control (asynchronous)
"""
...
import mate
from examples.hrl_v2.a3c.camera.agent import HRLv2A3CCameraAgent
from examples.hrl_v2.a3c.camera.train import experiment
...
def main():
    ...
    # Create agents
    camera_agent = HRLv2A3CCameraAgent(
    ...
    print(f"Evaluating HRL V2 A3C agent...")
