...
# Run: python -m examples.hrl_v2.qplex.camera.train
...
from examples.hrl_v2.qplex.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'hrl_v2.qplex.camera.{experiment.name}'
