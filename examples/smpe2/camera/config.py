"""SMPE2 — Config for PPO with variational belief + adversarial exploration.
...
Wrapper chain:
    ...
    → SMPE2Wrapper (intrinsic rewards)
    → FrameSkip
    → RLlibMultiAgentAPI
...
from examples.smpe2.wrappers import SMPE2Wrapper
...
def make_env(env_config):
    ...
    # SMPE2 intrinsic exploration rewards
    intrinsic_coeff = env_config.get('intrinsic_coeff', 0.1)
    env = SMPE2Wrapper(env, intrinsic_coeff=intrinsic_coeff)
...
tune.register_env('mate-smpe2.camera', make_env)

config = {
    'framework': 'torch',
    'seed': 0,
    # === Environment ==============================================================================
    'env': 'mate-smpe2.camera',
    'env_config': {
