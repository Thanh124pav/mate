...
from examples.tarmac.camera.train import train as _train
from examples.tarmac_focus.camera.config import config
...
def train(
    ...
    group = group or f"tarmac_focus.camera.{experiment.name}"
    return _train(
        experiment,
        project=project,
        group=group,
