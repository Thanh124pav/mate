"""QPLEX_SE (pure) — DiscreteCamera, no hierarchical target selection.
...
Shared encoder learns cross-agent representations with auxiliary prediction.

Run: python -m examples.qplex_se.camera.train --env MATE-4v8-9.yaml
"""
...
from ray.rllib.agents.qplex_se import DEFAULT_CONFIG
...
tune.register_env('mate-qplex_se.camera', make_env)

# Register trainer
from ray.rllib.agents.qplex_se.qplex import QPlexSETrainer
tune.register_trainable('QPLEX_SE', QPlexSETrainer)
