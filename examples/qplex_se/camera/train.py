...
# Run: python -m examples.qplex_se.camera.train
#      python -m examples.qplex_se.camera.train --env MATE-4v5-0.yaml
...
import mate
from examples.qplex_se.camera.config import config
...
def train(
    ...
    if WandbLoggerCallback.is_available():
        ...
        group = group or f'qplex_se.camera.{experiment.name}'
