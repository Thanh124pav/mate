...
import mate
from examples.qplex_se.camera.config import config as _config
from examples.qplex_se.camera.config import make_env as _make_env
from examples.utils import RLlibGroupedPolicyMixIn


class QPLEXSE_CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """QPLEX + Shared Encoder Camera Agent (pure, DiscreteCamera).
