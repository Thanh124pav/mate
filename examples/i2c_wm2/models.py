...
class I2CWM2Model(TorchRNN, nn.Module):
    def __init__(
        self,
        obs_space,
        action_space,
        ...
        **kwargs,
        ...
        if self.wm2_feature_dim > 0 and n_wm2_actions is None:
            raise ValueError('I2CWM2Model requires a discrete action space for WM2.')
        ...
        self.actor = SimpleRNN(
            name='actor',
            input_dim=self.local_obs_dim + self.message_dim + self.wm2_feature_dim,
    ...
    def forward_rnn(self, inputs, state, seq_lens):
        ...
        actor_input = torch.cat((local_obs, aggregated_message, wm2_feature), dim=-1)
    ...
    def custom_loss(self, policy_loss, loss_inputs):
        ...
        additional_loss = q_loss + prior_loss + self.policy_corr_reg_coeff * policy_corr_reg_loss + wm2_loss
...
ModelCatalog.register_custom_model('I2CWM2Model', I2CWM2Model)
