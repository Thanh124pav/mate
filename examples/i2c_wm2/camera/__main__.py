...
.. code:: bash
    ...
    python3 -m examples.i2c_wm2.camera

    python3 -m mate.evaluate --episodes 1 --render-communication \
        --camera-agent examples.i2c_wm2:I2CWM2CameraAgent \
...
import mate
from examples.i2c_wm2.camera.agent import I2CWM2CameraAgent
from examples.i2c_wm2.camera.train import experiment
...
def main():
    ...
    if not os.path.exists(args.checkpoint_path):
        print(
            (
                ...
                f'  python -m examples.i2c_wm2.camera.train'
            ),
            file=sys.stderr,
        )
        sys.exit(1)
    ...
    # Make agents ##############################################################
    camera_agent = I2CWM2CameraAgent(checkpoint_path=args.checkpoint_path)
