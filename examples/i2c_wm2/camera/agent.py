...
import mate
from examples.i2c_wm2.camera.config import config as _config
from examples.i2c_wm2.camera.config import make_env as _make_env
from examples.i2c_wm2.models import I2CWM2Model
from examples.utils import RLlibPolicyMixIn


class I2CWM2CameraAgent(RLlibPolicyMixIn, mate.CameraAgentBase):
    """I2C Camera Agent
    ...
    def __init__(self, config=None, checkpoint_path=None, make_env=_make_env, seed=None):
        ...
        assert isinstance(self.model, I2CWM2Model)
