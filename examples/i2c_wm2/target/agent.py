...
from examples.i2c_wm2.target.config import config as _config
from examples.i2c_wm2.target.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class I2CWM2TargetAgent(RLlibPolicyMixIn, mate.TargetAgentBase):
    """I2C Target Agent
