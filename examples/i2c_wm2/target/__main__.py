...
.. code:: bash
    ...
    python3 -m examples.i2c_wm2.target

    python3 -m mate.evaluate --episodes 1 --render-communication \
        --target-agent examples.i2c_wm2:I2CWM2TargetAgent \
...
import mate
from examples.i2c_wm2.target.agent import I2CWM2TargetAgent
from examples.i2c_wm2.target.train import experiment
...
def main():
    ...
    if not os.path.exists(args.checkpoint_path):
        print(
            (
                ...
                f'  python -m examples.i2c_wm2.target.train'
            ),
            file=sys.stderr,
        )
        sys.exit(1)
    ...
    target_agent = I2CWM2TargetAgent(checkpoint_path=args.checkpoint_path)
