...
import mate
from examples.qmix_wm2.target.config import config as _config
from examples.qmix_wm2.target.config import make_env as _make_env
from examples.utils import RLlibGroupedPolicyMixIn


class QMIXWM2TargetAgent(RLlibGroupedPolicyMixIn, mate.TargetAgentBase):
    """QMIX Target Agent
