...
.. code:: bash
    ...
    python3 -m examples.qmix_wm2.camera

    python3 -m mate.evaluate --episodes 1 --render-communication \
        --camera-agent examples.qmix_wm2:QMIXWM2CameraAgent \
...
import mate
from examples.qmix_wm2.camera.agent import QMIXWM2CameraAgent
from examples.qmix_wm2.camera.train import experiment
...
def main():
    ...
    if not os.path.exists(args.checkpoint_path):
        print(
            (
                ...
                f'  python -m examples.qmix_wm2.camera.train'
            ),
            file=sys.stderr,
        )
        sys.exit(1)
    ...
    # Make agents ##############################################################
    camera_agent = QMIXWM2CameraAgent(checkpoint_path=args.checkpoint_path)
