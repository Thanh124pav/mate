...
import mate
from examples.qmix_wm2.camera.config import config as _config
from examples.qmix_wm2.camera.config import make_env as _make_env
from examples.utils import RLlibGroupedPolicyMixIn


class QMIXWM2CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """QMIX Camera Agent
