...
import mate
from examples.ippo_wm2.target.config import config as _config
from examples.ippo_wm2.target.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class IPPOWM2TargetAgent(RLlibPolicyMixIn, mate.TargetAgentBase):
    """IPPO Target Agent
