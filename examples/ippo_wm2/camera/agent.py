...
import mate
from examples.ippo_wm2.camera.config import config as _config
from examples.ippo_wm2.camera.config import make_env as _make_env
from examples.utils import RLlibPolicyMixIn


class IPPOWM2CameraAgent(RLlibPolicyMixIn, mate.CameraAgentBase):
    """IPPO Camera Agent
