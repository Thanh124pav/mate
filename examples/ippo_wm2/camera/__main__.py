...
.. code:: bash
    ...
    python3 -m examples.ippo_wm2.camera

    python3 -m mate.evaluate --episodes 1 --render-communication \
        --camera-agent examples.ippo_wm2:IPPOWM2CameraAgent \
...
import mate
from examples.ippo_wm2.camera.agent import IPPOWM2CameraAgent
from examples.ippo_wm2.camera.train import experiment
...
def main():
    ...
    if not os.path.exists(args.checkpoint_path):
        print(
            (
                ...
                f'  python -m examples.ippo_wm2.camera.train'
            ),
            file=sys.stderr,
        )
        sys.exit(1)
    ...
    # Make agents ##############################################################
    camera_agent = IPPOWM2CameraAgent(checkpoint_path=args.checkpoint_path)
