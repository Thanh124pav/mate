...
DEFAULT_CONFIG = with_common_config({
    ...
    # === FOCUS ===
    # Future occupancy-guided credit assignment regularizes the QPLEX
    # advantage weights lambda_i toward a centralized training signal.
    "focus": {
        "enabled": True,
        "use_env_params": True,
        "alpha_credit": 0.05,
        ...
        "action_bias_eta": 0.0,
        "action_bias_bootstrap": True,
        "action_bias_confidence_enabled": True,
        "action_bias_confidence_std_threshold": 80.0,
        "action_bias_confidence_std_temperature": 40.0,
        "action_bias_confidence_min": 0.0,
        "action_bias_confidence_max": 1.0,
        "action_distill_enabled": False,
        "action_distill_coeff": 1.0,
        "action_distill_mode": "soft_kl",
        "action_distill_policy_q_enabled": True,
        "action_distill_policy_q_coeff": 1.0,
        "action_distill_bias_coeff": 0.5,
        "local_belief_enabled": False,
        "local_belief_coeff": 0.0,
        "local_belief_nll_coeff": 0.1,
        "local_belief_mse_coeff": 1.0,
        "local_belief_visible_nll_coeff": 0.0,
        "local_belief_visible_mse_coeff": 0.0,
        "local_belief_hidden_dim": 512,
        "local_belief_num_layers": 2,
        "local_belief_dropout": 0.0,
        "local_belief_min_std": 0.05,
        "local_belief_action_guide_enabled": False,
        "local_belief_action_eta": 1.0,
        "local_belief_action_distill_coeff": 0.0,
        "local_action_student_distill_coeff": 0.0,
        ...
        "student_action_bias_bootstrap": False,
...
class QPlexFocusTrainer(SimpleQTrainer):
    @classmethod
    ...
    def execution_plan(
        ...
        assert (
            len(kwargs) == 0
        ), "QPLEX execution_plan does NOT take any additional parameters"
