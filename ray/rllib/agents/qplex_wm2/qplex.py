"""QPLEX + Dreamer-style World Model (WM2) Trainer."""
...
DEFAULT_CONFIG = with_common_config({
    ...
    "world_model_v2": {
        ...
        "imagination_horizon": 5,   # H steps for imagination rollout
...
class QPlexWM2Trainer(SimpleQTrainer):
    @classmethod
    ...
    def validate_config(self, config: TrainerConfigDict) -> None:
        ...
        if config["framework"] != "torch":
            raise ValueError("Only framework=torch supported for QPlexWM2Trainer!")

    @override(SimpleQTrainer)
    def get_default_policy_class(self, config: TrainerConfigDict) -> Type[Policy]:
        return QPLEXWM2TorchPolicy
