...
from ray.rllib.agents.duelmix_focus.duelmix_policy import DuelMixLoss, DuelMixTorchPolicy
...
class DuelMixFocus2Loss(DuelMixLoss):
    ...
    def __init__(self, obs_space, action_space, config):
        ...
        if focus_config.get("enabled", True):
            self.occupancy_model = _build_focus2_belief_model(
                self, focus_config, "DUELMIX_FOCUS2"
            )
